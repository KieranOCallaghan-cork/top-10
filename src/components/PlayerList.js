...
const PlayerList = () => {
    ...
    const [selectedPlayer, setSelectedPlayer] = useState(null); // Player selected for update
    const [updatedGoals, setUpdatedGoals] = useState(''); // New goals value for update
    const [showModal, setShowModal] = useState(false); // Modal state for update confirmation
